...
proc endzoneTints(gameMap: MpeMap): seq[EndzoneTint] =
...
proc loadMapLayers*(gameMap: MpeMap, withEndzoneGlow = true):
...
proc coldEndzoneMapRgba*(gameMap: MpeMap): seq[uint8] =
